    ...
    <div class="wrap"> 
        ...
        <form action="options.php" method="post"> 
            ...
            <table class="form-table">
                ...
                <tr><th>Sisempi reuna</th><td><input type="text" name="tubetus_inner_border" value="<?php echo esc_attr(get_option('tubetus_inner_border', '1px solid')); ?>" class="tubetus-input-fixed" /> <input type="text" name="tubetus_inner_border_clr" value="<?php echo esc_attr(get_option('tubetus_inner_border_clr', '#e2e8f0')); ?>" class="color-field" /></td></tr>
...
function tubetus_forum_render_output() { 
    $cached = get_transient('tubetus_forum_cache');
    ...
    $query = "SELECT t.topic_id, t.topic_title, t.topic_last_post_time as topic_time, u.username, u.user_avatar, u.user_avatar_type 
              ...
              WHERE t.topic_moved_id = 0 AND t.topic_visibility = 1
    ...
    $output = ob_get_clean(); 
    $mysqli->close();
    set_transient('tubetus_forum_cache', $output, 30); 
    return $output; 
} 
